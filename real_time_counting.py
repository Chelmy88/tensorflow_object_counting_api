...
output_video="/output/real_time_counting.avi"
...
object_counting_api.object_counting(input_video, output_video, detection_graph, category_index, is_color_recognition_enabled) # counting all the objects
