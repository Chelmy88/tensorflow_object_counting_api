...
output_video="/output/pedestrian_counting.avi"
...
object_counting_api.cumulative_object_counting_x_axis(input_video, output_video, detection_graph, category_index, is_color_recognition_enabled, roi, deviation) # counting all the objects
